...
class Feedback:
    ...
    def __init__(self, master):
        ...
        ttk.Label(self.frame_header, text = 'Anlegg Driftslogg', style = 'Header.TLabel').grid(row = 0, column = 1)
        ttk.Label(self.frame_header, wraplength = 300,
                  text = ("Welcome to the program to record Operational log from the Molding Line.  "
                          "Please write down your information below.")).grid(row = 1, column = 1)
